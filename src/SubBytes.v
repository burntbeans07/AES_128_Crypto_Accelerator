module SubBytes(input wire [127:0] din, output wire [127:0]subbed);
    ...
    Sbox_LUT x8(b8,s8);
    Sbox_LUT x9(b9,s9);
    Sbox_LUT x10(b10,s10);
    Sbox_LUT x11(b11,s11);
    Sbox_LUT x12(b12,s12);
    Sbox_LUT x13(b13,s13);
    Sbox_LUT x14(b14,s14);
    Sbox_LUT x15(b15,s15);
